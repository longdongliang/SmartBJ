...
public class CustomViewAbove extends ViewGroup {
	...
	protected static final String TAG = "CustomViewAbove";
	...
	protected OnPageChangeListener mInternalPageChangeListener;

	//	protected OnCloseListener mCloseListener;
	//	protected OnOpenListener mOpenListener;
	protected OnClosedListener mClosedListener;
	protected OnOpenedListener mOpenedListener;

	protected List<View> mIgnoredViews = new ArrayList<View>();
	...
	protected boolean isInIgnoredView(MotionEvent ev) {
		Rect rect = new Rect();
	...
	protected boolean thisTouchAllowed(MotionEvent ev) {
	...
	protected boolean thisSlideAllowed(float dx) {
	...
	protected int getPointerIndex(MotionEvent ev, int id) {
	...
	protected boolean mQuickReturn = false;
	...
	protected void determineDrag(MotionEvent ev) {
	...
	protected int determineTargetPage(float pageOffset, int velocity, int deltaX) {
