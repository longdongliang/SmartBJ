...
public class CustomViewBehind extends ViewGroup {
	...
	protected static final int MARGIN_THRESHOLD = 48; // dips
	protected int mTouchMode = SlidingMenu.TOUCHMODE_MARGIN;

	protected CustomViewAbove mViewAbove;

	protected View mContent;
	protected View mSecondaryContent;
	protected int mMarginThreshold;
	protected int mWidthOffset;
	protected CanvasTransformer mTransformer;
	protected boolean mChildrenEnabled;
	...
	protected int mMode;
	protected boolean mFadeEnabled;
	protected final Paint mFadePaint = new Paint();
	protected float mScrollScale;
	protected Drawable mShadowDrawable;
	protected Drawable mSecondaryShadowDrawable;
	...
	protected boolean mSelectorEnabled = true;
	protected Bitmap mSelectorDrawable;
