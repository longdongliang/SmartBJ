...
public class SlidingActivityHelper {
	...
	protected View mViewAbove;

	protected View mViewBehind;

	protected boolean mBroadcasting = false;

	protected boolean mOnPostCreateCalled = false;

	protected boolean mEnableSlide = true;
